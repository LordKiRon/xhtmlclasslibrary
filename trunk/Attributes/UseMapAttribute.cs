...
{
    public class UseMapAttribute : BaseAttribute
    {
        private IdReference attrObject = new IdReference();

        internal const string attributeName = "usemap";
