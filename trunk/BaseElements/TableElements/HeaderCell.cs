...
namespace XHTMLClassLibrary.BaseElements.TableElements
{
    ...
    public class HeaderCell : BaseTableElement
    {
        ...
        private readonly ScopeAttribute scopeAttribute = new ScopeAttribute();
        ...
        /// </summary>
        public ScopeAttribute Scope { get { return scopeAttribute; } }
        ...
        public override void Load(XNode xNode)
        {
            ...
            scopeAttribute.ReadAttribute(xElement);
        ...
        public override XNode Generate()
        {
            ...
            scopeAttribute.AddAttribute(xElement);
