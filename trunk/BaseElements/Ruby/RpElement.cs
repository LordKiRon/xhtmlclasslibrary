...
{
    /// <summary>
    /// The rp element can be used to specify characters that can denote the beginning and end of ruby text. 
    /// The rp element should only be used for simple ruby markup, and when Web browsers do not support standard ruby notation.
    /// </summary>
