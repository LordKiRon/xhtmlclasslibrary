...
{
    public class AcceptAttribute : BaseAttribute
    {
        private ContentType attrObject = new ContentType();

        internal const string attributeName = "accept";
